...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 relative overflow-hidden bg-grid">
      {/* Background Effects */}
      ...
      <div className="relative z-10 w-full max-w-2xl mx-4">
        <div className="glass rounded-3xl p-8 sm:p-10 shadow-2xl">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 rounded-2xl mb-4 animate-pulse-glow">
              <span className="text-white font-black text-2xl">SU</span>
            </div>
            ...
            <div>
              <label className="flex items-start gap-3 cursor-pointer group">
                <input
                  type="checkbox"
                  required
                  className="w-4 h-4 mt-1 rounded border-slate-700 bg-slate-800 text-cyan-500 focus:ring-2 focus:ring-cyan-500 focus:ring-offset-0 transition-all"
                />
